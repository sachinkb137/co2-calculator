...
import creditsBg from '../../assets/creditsBg.jpg'
...
const CarbonCreditsCalculator = () => {
    ...
    return (
        ...
        >
            <div className="bg-white/50 backdrop-blur-sm p-8 rounded-2xl shadow-lg shadow-black max-w-md mx-auto">
